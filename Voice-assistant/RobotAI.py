...
def step3():
    move(11, 1, 0.000000001, 90)
    move(10, 1, 0.0000000001,80)
    move(12, 0.5, 0.01, 30)
    move(4, 1, 0, 135)
    move(5, 1, 0, 165)
    move(12, -1, 0.01, 10)
...
def search_query(query):
    try:
        ...
        page = requests.get(URL, headers=headers)
        soup = BeautifulSoup(page.content, 'html.parser')
        answer = soup.find(class_='BbbuR uc9Qxb uE1RRc').get_text()
        i_know()
        speak(answer)
        print(answer)
    except Exception:  # and result == "" or Exception and result == "":
        try:
            ...
            result = soup.find(class_='TIGsTb').get_text()
...
if __name__ == "__main__":
    speak("Hello! Pleased to meet you")
    speak("I am Quandale Dingle. How may I help you?")
    global my_timer
    while True:
        LED.value = 0
        led.value = 1
